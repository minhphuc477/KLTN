...
def generate_room(
    ...
    metrics = {
        ...
        **topology_betti_metrics,
        ...
        'neural_puzzle_scaffold_interaction_targeted_push_slot_count': int(neural_puzzle_scaffold.get('interaction_targeted_push_slot_count', 0) or 0),
        ...
        'final_puzzle_scaffold_interaction_targeted_push_slot_count': int(final_puzzle_scaffold.get('interaction_targeted_push_slot_count', 0) or 0),
