...
def generation_runtime_kwargs_from_resolved_config(config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        ...
        "map_elites_preference_buffer_size": stage.get("map_elites_preference_buffer_size", 0),
    ...
    kwargs.update(
        {
            ...
            "diffusion_fallback_config": {
                "latent_dim": diffusion["latent_dim"],
                "latent_scale_factor": diffusion.get("latent_scale_factor", 1.0),
            ...
            "logic_net_fallback_config": {
                ...
                "logic_final_temperature": diffusion.get("logic_final_temperature", 0.05),
