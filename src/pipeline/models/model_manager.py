...
def load_logic_net(pipeline, checkpoint_path: Optional[str]) -> LogicNet:
    ...
    model = LogicNet(
        ...
        grid_pathfinder_type=str(fallback_config.get("logic_grid_pathfinder", "cnn")),
    ...
    if checkpoint_path and Path(checkpoint_path).exists():
        ...
        model = LogicNet(
            ...
            grid_pathfinder_type=str(checkpoint_config.get("logic_grid_pathfinder", fallback_config.get("logic_grid_pathfinder", "cnn"))),
