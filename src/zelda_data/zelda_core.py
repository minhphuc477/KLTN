...
class RoomGraphMatcher:
        ...
        if graph_triforce_node is not None:
            ...
            if triforce_room_pos:
                logger.debug(
                    ...
                    graph_triforce_node, triforce_room_pos
                )
    ...
    def _match_rooms_to_nodes_bfs(self, rooms: Dict[Tuple[int, int], Room],
        ...
        try:
            ...
            try:
                _consistency_after = _try_improve_swaps()
            except Exception:
    ...
    def infer_missing_mappings(self, rooms: Dict[Tuple[int, int], Room],
        ...
        for room_anchor, node_anchor in anchors:
            r2n, _n2r = self._match_rooms_to_nodes_bfs(rooms, self._build_room_adjacency(rooms), graph, room_anchor, node_anchor)
...
class ZeldaDungeonAdapter:
    ...
    def load_dungeon(self, dungeon_num: int, variant: int = 1) -> Dungeon:
        ...
        self._log_virtual_node_report(dungeon, context=f"load:v{variant}")
