...
from src.gui.ai.generation_controls import (
    generate_level as _generate_level,
    select_ai_model_checkpoint as _select_ai_model_checkpoint,
    start_ai_dungeon_generation as _start_ai_dungeon_generation,
)
...
def select_ai_model_checkpoint(*, gui, logger):
    _select_ai_model_checkpoint(gui, logger)


def generate_level(*, gui, logger):
    _generate_level(gui, threading, logger)
