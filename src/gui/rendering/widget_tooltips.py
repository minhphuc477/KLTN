...
def render_tooltips(gui: Any, surface: Any, mouse_pos: tuple, button_widget_cls: Any, pygame: Any) -> None:
    ...
    tooltips = {
        ...
        "show_path": "Show or hide the current solution path",
        "smooth_camera": "Enable smooth camera transitions",
        "show_grid": "Toggle grid overlay on map",
        "level": "Choose the generated level to inspect or solve",
        "zoom": "Adjust map zoom level (also use +/- keys)",
        "difficulty": "Select map difficulty level",
        "algorithm": "Choose the solver for Solve Level",
        "diagonal_movement": "Allow diagonal player and solver movement",
    ...
    button_tooltips = {
        ...
        "Solve Level": "Solve the selected level with the chosen solver (SPACE)",
        "Stop": "Stop the current auto-solve operation",
        "Generate Dungeon": "Create a new random dungeon map (BSP)",
        "Load Model": "Select an AI checkpoint for generated levels",
        "Generate Level": "Generate with the loaded AI model, or BSP if none is loaded",
        "AI Generate": "Generate dungeon using trained latent diffusion AI model",
        "Reset": "Reset current map to initial state (R key)",
        "Reset Level": "Reload the selected level and reset the player",
