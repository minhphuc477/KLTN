...
def render_path_guaranteed(*, gui, surface, pygame, math_module, time_module, logger, render_path_guaranteed_flow_helper):
    return render_path_guaranteed_flow_helper(
        gui=gui,
        surface=surface,
        pygame=pygame,
