...
try:
    from .logic_net import LegacyLogicNet, LogicNet, SoftBellmanFord
    _ = (LegacyLogicNet, LogicNet, SoftBellmanFord)
    __all__ = ['LogicNet', 'LegacyLogicNet', 'SoftBellmanFord', 'HeuristicNetwork', 'TrainingExample']
except ImportError:
