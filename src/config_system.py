...
CONFIG_FIELDS: List[ConfigField] = [
    ...
    ConfigField("diffusion.topology_refinement_mode", str, "gat2", "Topology refinement inside attention.", choices=("none", "lightweight", "sparse_edge", "gat2", "graphormer", "upgraded")),
