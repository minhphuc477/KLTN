...
CONFIG_FIELDS: List[ConfigField] = [
    ...
    ConfigField("diffusion.topology_refinement_mode", str, "gat2", "Topology refinement inside attention.", choices=("none", "lightweight", "sparse_edge", "sparse_directed", "sparse_semantic", "sparse_directed_semantic", "gat2", "gat2_directed", "gat2_semantic", "gat2_directed_semantic", "graphormer", "graphormer_learned", "upgraded")),
