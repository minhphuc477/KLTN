...
CONFIG_FIELDS: List[ConfigField] = [
    ...
    ConfigField("diffusion.condition_strict_schema", bool, False, "Fail on graph-conditioning schema shape drift instead of pad/truncate compatibility alignment."),
    ...
    ConfigField("masked_room.condition_strict_schema", bool, False, "Fail on masked-room graph-conditioning schema shape drift instead of pad/truncate compatibility alignment."),
