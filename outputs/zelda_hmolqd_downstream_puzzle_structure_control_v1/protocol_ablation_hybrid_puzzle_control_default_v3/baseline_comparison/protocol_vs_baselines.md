...
- `diffusion_cfg3_logic0_steps50`: repair=0.8889, overwrite=0.1667, pre_anchor=4.5000, post_anchor=0.0000, A*=1.0000, softlock=1.0000, gauntlet=1.0000, CBS=1.0000, CBS_confusion=57.9185, time=149.40s
- `fast_cfg3_logic0_steps4`: repair=0.8889, overwrite=0.2222, pre_anchor=6.0000, post_anchor=0.0000, A*=1.0000, softlock=1.0000, gauntlet=1.0000, CBS=1.0000, CBS_confusion=57.9259, time=141.49s
- `masked_room_full`: repair=0.7222, overwrite=0.1944, pre_anchor=5.2500, post_anchor=0.0000, A*=1.0000, softlock=1.0000, gauntlet=1.0000, CBS=1.0000, CBS_confusion=8.8222, time=96.08s
