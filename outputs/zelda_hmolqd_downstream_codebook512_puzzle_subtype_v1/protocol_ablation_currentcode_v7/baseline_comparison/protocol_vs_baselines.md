...
- `diffusion_cfg3_logic0_steps50`: repair=0.8611, overwrite=0.2778, pre_anchor=7.5000, post_anchor=0.0000, A*=1.0000, softlock=1.0000, gauntlet=1.0000, CBS=0.6667, CBS_confusion=2.3000, time=122.92s
- `fast_cfg3_logic0_steps4`: repair=0.8889, overwrite=0.2222, pre_anchor=6.0000, post_anchor=0.0000, A*=1.0000, softlock=1.0000, gauntlet=1.0000, CBS=1.0000, CBS_confusion=2.1852, time=131.35s
- `masked_room_full`: repair=0.8611, overwrite=0.1667, pre_anchor=4.5000, post_anchor=0.0000, A*=1.0000, softlock=1.0000, gauntlet=1.0000, CBS=1.0000, CBS_confusion=2.3778, time=94.32s
