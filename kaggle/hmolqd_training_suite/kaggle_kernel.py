...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--mode",
        choices=("training", "evidence", "full", "all_ablations"),
        default=os.environ.get("KAGGLE_SUITE_MODE", "training"),
        help="Run training, evidence, train plus evidence, or the full tokenizer/branch ablation matrix.",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    script_name = {
        ...
        "all_ablations": "run_kaggle_all_ablations.sh",
    }[str(args.mode)]
